...
<html>
  ...
  <form action="search.php" method="get" class="search">
    ...
    <input class="sumbit" type="submit" value="Cari" id="src" onclick="return validasiCari()">
  </form>
    </div>
    <div class="wrapper">
              <h2>Data Mapel</h2>
    <table cellspacing='1' class="mapel">
      <thead class="tmapel">
      <tr>
        <th class="mapel1">No.</th>
        <th class="mapel1">Kode</th>
        <th class="mapel1">Mapel</th>
        <th class="mapel1">Alokasi Waktu</th>
        <th class="mapel1">Semester</th>
        <th class="mapel1">Guru Pengajar</th>
        <th colspan="2" class="mapel1">Aksi</th>
      </tr>
      </thead>
      <?php
      if ($num > 0) {
    ...
    <br>
      <form action="../mapel/form-create.php" method="post">
        <input type="submit" value="Tambah Data" class="submet">
      </form>
      <br>
  </body>
</html>
